...
for lr in learning_rates:
        ...
        optimizer = nn.optimizer.MomentGD(init_lr=lr, model=linear_model, mu=0.9)  # 使用MomentGD优化器，公式为Q2中要求的公式
        ...
        runner.train([train_imgs, train_labs], [valid_imgs, valid_labs], num_epochs=3, log_iters=100, save_dir=f'./best_models/lr_{lr}')

        # 记录验证集上的最佳准确率
        results[lr] = runner.best_score
